...
namespace vz::image
{
	...
	struct Params
	{
		...
		const graphics::Texture* maskMap = nullptr;
		const graphics::Texture* backgroundMap = nullptr;
		...
		//	the background tex should be bound with image::SetBackground() beforehand
