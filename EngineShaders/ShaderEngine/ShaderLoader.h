...
namespace vz::shader
{
	enum SHADERTYPE : uint32_t
	{
		...
		CSTYPE_MESHLET_PREPARE, // to save GBffuer size: refers to "visibility_resolveCS.hlsl"
	...
	{
		DEBUG_RENDERING_ENVPROBE,
		DEBUG_RENDERING_DDGI,
		DEBUG_RENDERING_VOXEL,
		DEBUG_RENDERING_GRID,

		DEBUG_RENDERING_LINES,
		DEBUG_RENDERING_LINES_DEPTH, 
		DEBUG_RENDERING_CUBE,
		DEBUG_RENDERING_CUBE_DEPTH,

		MESH_RENDERING_LINES_DEPTH,	// Not for Debug 
